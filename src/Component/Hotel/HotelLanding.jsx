                ...
                <div className="relative ">
                    <div className="px-4 py-20 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                        <div className="flex flex-col py-5 text-center lg:py-12 items-center justify-between " data-aos="zoom-in-up">
                            <h4 className='text-4xl lg:text-6xl   font-normal text-white' > Make your Hotel </h4>
                            ...
                            <div className="flex  flex-col p-5  mt-20 inset-x-0 top-0  text-black dark:text-white  md:px-10 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border-2 gap-10 md:mx-32 w-12/12 md:w-10/12 bg-white rounded-2xl md:p-10" data-aos="fade-up">
                                ...
                                <div className='flex flex-row-reverse gap-5 cursor-pointer'>
                                    <button className='bg-sky-300 p-2.5 text-sm lg:text-md text-white hover:border-2 hover:border-sky-300 hover:bg-transparent border-2'>Show Filghts</button>
                ...
                <div className="grid lg:hidden lg:grid-cols-3 grid-rows-2 gap-4">
                    <div className="col-span-2 row-span-2 lg:row-span-2 p-5 bg-sky-300 dark:bg-sky-900 flex flex-col gap-5 justify-between rounded-xl">
                        <div className='flex flex-row items-center justify-evenly'>
                            <h4 className='text-2xl lg:text-4xl '>The Full Dubai Experience</h4>
                            <div className='flex flex-col bg-white dark:text-sky-900  p-2 rounded-lg items-center'>
                                <p className='font-light text-xl'>from</p>
                                <h4 className='font-bold text-2xl'>$1700</h4>
                            </div>
                        </div>
                    ...
                    <div className='lg:row-start-3' ><img src="img/hotel-1.svg" alt="" /></div>
                    <div className='lg:row-start-3' ><img src="img/hotel-2.svg" alt="" /></div>
                    <div className="row-start-4 lg:col-start-2 lg:row-start-2"><img src="img/hotel-3.svg" alt="" /></div>
                    <div className="row-start-4 lg:col-start-3 lg:row-start-2"><img src="img/hotel-4.svg" alt="" /></div>
                </div>

                <div className="hidden lg:grid grid-cols-3 grid-rows-2 gap-4">
                    <div className="row-span-2 p-5 bg-sky-300 dark:bg-sky-900 flex flex-col gap-10 justify-center rounded-xl">
                        <div className='flex flex-row items-center justify-evenly'>
                            <h4 className='text-2xl lg:text-3xl '>The Full Dubai Experience</h4>
                            <div className='flex flex-col bg-white dark:text-sky-900  p-2 rounded-lg items-center'>
                                <p className='font-light text-xl'>from</p>
                                <h4 className='font-bold text-2xl'>$1700</h4>
                            </div>
                    ...
                    <div ><img src="img/hotel-1.svg" alt="" /></div>
                    <div ><img src="img/hotel-2.svg" alt="" /></div>
                    <div className="col-start-2 row-start-2"><img src="img/hotel-3.svg" alt="" /></div>
                    <div className="col-start-3 row-start-2"><img src="img/hotel-4.svg" alt="" /></div>
                </div>
