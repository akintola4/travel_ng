...
export default function Review(props) {
  return (
    <div>
        <div className='flex flex-col gap-2 review border-2 md:w-10/12 lg:w-8/12 card p-5 border-slate-100 rounded-xl  dark:bg-gray-800 shadow-[5px_5px_rgba(137,_207,_240,_0.4),_10px_10px_rgba(137,_207,_240,_0.3),_15px_15px_rgba(137,_207,_240,_0.2)]'>
